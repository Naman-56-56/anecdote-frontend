export default function Footer() {
    return (
        <div
            id="shopify-section-sections--17655277387948__footer"
            className="shopify-section shopify-section-group-group-footer"
        >
            <style>{`#SiteFooter {
    --PT: 60px;
    --PB: 60px;
...
#SiteFooter .footer-bottom { --grid-columns: 3; }`}</style>
            <footer
                id="SiteFooter"
                className="section-padding site-footer"
                role="contentinfo"
                data-section-id="sections--17655277387948__footer"
                data-section-type="footer"
            >
                <div className="footer-content wrapper">
                    <div className="footer-blocks">
                        <div
                            className="footer-block footer-block--menu text-left"
                            data-aos="fade-up"
                            data-aos-anchor="#SiteFooter"
                            data-aos-delay="150"
                            style={{ '--desktop-width': '20%' }}
                        >
                            <p className="footer-title footer-title--links">
                                <button
                                    className="footer-title__button h5"
                                    aria-controls="FooterMenu--quick-links-0"
                            ...
                            <div
                                className="footer-links__wrapper"
                                id="FooterMenu--quick-links-0"
                                data-collapsible-container-mobile=""
                            >
                                <ul className="footer-links" data-collapsible-content="">
                                    <li>
                                        <a
                                            className="footer-link"
                                            href="https://astatementof.com/pages/pre-order-information"
                                        >
                                    ...
                                    <li>
                                        <a
                                            className="footer-link"
                                            href="https://astatementof.com/pages/size-guide"
                                        >
                                            Size Guide
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a
                                            className="footer-link"
                                            href="https://astatementof.com/pages/contact-us"
                                        >
                                            Contact Us
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            className="footer-link"
                                            href="https://astatementof.com/pages/returns-and-other-information"
                                        >
                                    ...
                                    <li>
                                        <a
                                            className="footer-link"
                                            href="https://astatementof.com/pages/privacy-policy"
                                        >
                                            Privacy Policy
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            className="footer-link"
                                            href="https://astatementof.com/pages/terms-of-service"
                                        >
                                            Terms of Service
                                        </a>
                                    </li>
                        ...
                        <div
                            className="footer-block footer-block--newsletter text-left"
                            data-aos="fade-up"
                            data-aos-anchor="#SiteFooter"
                            data-aos-delay="300"
                            style={{ '--desktop-width': '30%' }}
                        >
                            <div className="footer-title h5">NEWSLETTER</div>
                            <div className="rte">
                                <p>Stay up to date with the new collections, products and exclusive offers.</p>
                            </div>
                            <form
                                method="post"
                                action="https://astatementof.com/contact#NewsletterForm--footer-block-3"
                                id="NewsletterForm--footer-block-3"
                                acceptCharset="UTF-8"
                            ...
                            >
                                ...
                                <div className="input-group input-group--inline">
                                    <div className="input-group__fields">
                                        <div className="input-group__item input-group__item--email">
                                            <input
                                                type="email"
                                                id="Email--footer-block-3"
                                                className="input-group__field input-group__field--email"
                                                defaultValue=""
                                    ...
                                    <div className="input-group__item input-group__item--btn">
                                        <button
                                            type="submit"
                                            name="subscribe"
                                            id="SubscribeSubmit--footer-block-3"
                                            className="input-group__btn input-group__btn--icon"
                                        >
                                            <span className="visually-hidden">Subscribe to Our Newsletter</span>
                                            <svg
                                                aria-hidden="true"
                                                focusable="false"
                                                role="presentation"
                                ...
                                <div className="errors">Email is invalid or already taken.</div>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div
                    className="footer-bottom wrapper text-left"
                    data-aos="fade-up"
                    data-aos-anchor="#SiteFooter"
                    data-aos-delay="450"
                >
                    <div className="social-sharing-wrapper">
                        <a
                            className="social-sharing-icon instagram"
                            rel="noopener"
                            href="https://www.instagram.com/astatementof"
                            title="View a statement of on Instagram"
                        >
                            <svg
                                aria-hidden="true"
                                focusable="false"
                        ...
                        <a
                            className="social-sharing-icon tiktok"
                            rel="noopener"
                            href="https://www.tiktok.com/@astatementof"
                            title="View a statement of on Tiktok"
                        >
                            <svg
                                aria-hidden="true"
                                focusable="false"
                        ...
                        <a
                            className="social-sharing-icon twitter"
                            rel="noopener"
                            href="https://twitter.com/astatementof"
                            title="View a statement of on Twitter"
                        >
                            <svg
                                aria-hidden="true"
                                focusable="false"
                        ...
                        <a
                            className="social-sharing-icon youtube"
                            rel="noopener"
                            href="https://www.youtube.com/@astatementof"
                            title="View a statement of on Youtube"
                        >
                            <svg
                                aria-hidden="true"
                                focusable="false"
                    ...
                    <div className="footer-bottom__content">
                        <div className="footer-copyright">
                            <div className="footer-copyright__content">
                                <span className="footer-copyright__copy">
                                    &copy; 2025,{' '}
                                    <a href="https://astatementof.com/" title="">
                                        a statement of
                                    </a>
                                    .
                                </span>
